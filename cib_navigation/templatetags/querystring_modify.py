...
def querystring_modify(
    ...
    * Add a new "baz" item with the value `1`
    ...
    {% querystring_modify foo="NEWFOOVAL" bar=None baz=1 %}```
    ```
    ...
    ```
    {% load querystring_modify %}
    {% querystring_modify tags=tag_list %}
    ```
    ...
    ```
    {% load querystring_modify %}
    {% querystring_modify tags__remove='tag2' %}
    ```
    ...
    ```
    {% load querystring_modify %}
    {% querystring_modify tags__add='tagNew' %}
    ```
    ...
    ```
    {% load querystring_modify %}
    {% querystring_modify tags__toggle='tagNew' %}
    ```
    ...
    ```
    {% load querystring_modify %}
    {% querystring_modify page=None tags__add="newTag" tags__remove="oldTag" %}
    ```
